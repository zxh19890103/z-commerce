...
namespace Nt.DAL
{
    ...
    public sealed class SqlHelper
    {
        ...
        private static void PrepareCommand(SqlCommand command, SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, out bool mustCloseConnection)
        {
            ...
            //System.IO.StreamWriter writer = System.IO.File.CreateText("../../log2.txt");
        ...
        #region 数据库连接
        static string _ntConnectionString;
        /// <summary>
        /// 一个有效的数据库连接字符串
        /// </summary>
        /// <returns></returns>
        ...
        {
            if (string.IsNullOrEmpty(_ntConnectionString))
                _ntConnectionString = File.ReadAllLines(AppDomain.CurrentDomain.BaseDirectory + @"App_Data\Connection.txt")[0];
            return _ntConnectionString;
        }
        /// <summary>
        /// 一个有效的数据库连接对象
        /// </summary>
        ...
        /// <summary>
        /// 根据给定的commandText执行数据库操作
        /// </summary>
        /// <param name="commandText">T-Transaction语句</param>
        /// <returns>返回受影响的行数</returns>
        public static int ExecuteNonQuery(string commandText)
        {
            return ExecuteNonQuery(GetConnection(), CommandType.Text, commandText);
        }
        ...
        {
            return ExecuteDataset(GetConnection(), CommandType.Text, commandText);
        }
        ...
        {
            return ExecuteReader(GetConnection(), CommandType.Text, commandText);
        }
        ...
        /// </summary>
        /// <param name="commandText">字符串的命令</param>
        /// <returns>返回结果集中的第一行第一列</returns>
        public static object ExecuteScalar(string commandText)
        {
            return ExecuteScalar(GetConnection(), CommandType.Text, commandText);
        }
