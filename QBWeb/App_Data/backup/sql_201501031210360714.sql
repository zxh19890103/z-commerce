...
GO
--drop Foreign Key 'FK_Nt_OrderItem_Nt_Goods' 
IF OBJECT_ID(N'[dbo].[FK_Nt_OrderItem_Nt_Goods]','F') IS NOT NULL
  ALTER TABLE [dbo].[Nt_OrderItem] DROP CONSTRAINT [FK_Nt_OrderItem_Nt_Goods];
GO
...
ON DELETE CASCADE ON UPDATE NO ACTION;
GO
--Creating Foreign Key 'FK_Nt_OrderItem_Nt_Goods' 
ALTER TABLE [dbo].[Nt_OrderItem]
ADD CONSTRAINT [FK_Nt_OrderItem_Nt_Goods]
FOREIGN KEY ([GoodsId]) REFERENCES [dbo].[Nt_Goods]([Id])
ON DELETE CASCADE ON UPDATE NO ACTION;
GO
