<%@ Page Language="C#" AutoEventWireup="false" CodeFile="index.aspx.cs" Inherits="install_index" %>
        ...
        <div class="install-box">
            <table>
                ...
                <tr>
                    ...
                    <td class="cellData">
                        <input type="checkbox" name="IntegratedSecurity" onclick="var ops = $('tr.options', '#installForm'); if (setCheck(this)) ops.hide(); else ops.show();" value="false" />
                    </td>
                </tr>
                <tr class="options">
                ...
                <tr>
                    <td></td>
                    <td align="center">
                        <input type="button" class="install-button" onclick="install(); return false;" value="安装" />
