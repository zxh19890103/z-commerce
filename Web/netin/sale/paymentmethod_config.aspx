<%@ Page Language="C#" AutoEventWireup="false" CodeFile="paymentmethod_config.aspx.cs" Inherits="netin_sale_paymentmethod_config" %>
...
<body>
    <form action="paymentmethod_config.aspx" method="post" id="editForm">
