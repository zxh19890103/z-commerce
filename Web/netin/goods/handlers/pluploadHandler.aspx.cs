...
public partial class netin_goods_handlers_pluploadHandler : System.Web.UI.Page
{
    protected override void OnLoad(EventArgs e)
    {
        MediaService ms = new MediaService();
        ms.CurrentUploadCategory = "goods";
        ...
        {
            int goodsid;
            NtJson.EnsureNumber("goodsid", "参数错误:goodsid", out goodsid);
            ...
            sql += "insert into Nt_Goods_Picture_Mapping(GoodsId,PictureId)values(" + goodsid + ",@newid)\r\n";
            sql += "select @newId;\r\n";
