<%@ Page Language="C#" MasterPageFile="~/netin/layout.master" AutoEventWireup="false" CodeFile="settings.aspx.cs" Inherits="netin_goods_settings" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="head">
    <style type="text/css">
        .interval-refresh-text-box { font-size: 18px; font-style: italic; color:#f00;}
    </style>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="body">
    ...
    <div class="submit-top">
        ...
        <a class="a-button" href="javascript:;" onclick="handleMedias(<%=WaterMarker.DEL_GOODS_THUMBNAIL %>);">删除缩略图</a>

        <a class="a-button" href="javascript:;" onclick="handleMedias(<%=WaterMarker.DEL_GOODS_WATER %>);">删除水印图</a>

        <br />

        <a href="javascript:;" onclick="handleMedias(<%=WaterMarker.GENERATE_GOODS_THUMBNAIL %>,<%=(int)ThumbOn.List %>);">按设置生成列表页缩略图</a>

        <a href="javascript:;" onclick="handleMedias(<%=WaterMarker.GENERATE_GOODS_THUMBNAIL %>,<%=(int)ThumbOn.Detail %>);">按设置生成详细页缩略图</a>

        <a href="javascript:;" onclick="handleMedias(<%=WaterMarker.GENERATE_GOODS_THUMBNAIL %>,<%=(int)ThumbOn.Home %>);">按设置生成首页缩略图</a>

        <a href="javascript:;" onclick="handleMedias(<%=WaterMarker.GENERATE_GOODS_TEXT_WATER %>);">按设置生成文字水印图</a>

        <a href="javascript:;" onclick="handleMedias(<%=WaterMarker.GENERATE_GOODS_IMG_WATER %>);">按设置生成图片水印图</a>
        <br />
