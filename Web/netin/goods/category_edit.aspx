<%@ Page Language="C#" MasterPageFile="~/netin/layout.master" AutoEventWireup="false" CodeFile="category_edit.aspx.cs" Inherits="Netin_Goods_category_edit" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="body">
    <form action="category_edit.aspx" method="post" id="editForm">
        ...
        <div class="submit">
            ...
            <a class="a-button" href="javascript:;" onclick="save();">保存</a>
            <a class="a-button" href="javascript:;" onclick="editForm.reset();">重置</a>
            <a class="a-button" href="category_list.aspx">返回</a>
        </div>
    </form>
