<%@ Page Language="C#" MasterPageFile="~/netin/layout.master" AutoEventWireup="false" CodeFile="article_class_edit.aspx.cs" Inherits="netin_article_article_class_edit" %>
...
<asp:Content runat="server" ContentPlaceHolderID="body">
    <form action="article_class_edit.aspx" method="post" id="editForm">
        ...
        <table class="adminContent" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                ...
                <td class="adminData">
                    <input type="text" class="input-long" onfocus="selectTemplate(this);" maxlength="256" name="ListTemplate" value="<%=Model.ListTemplate %>" />
            ...
            <tr>
                ...
                <td class="adminData">
                    <input type="text" class="input-long" onfocus="selectTemplate(this);" maxlength="256" name="DetailTemplate" value="<%=Model.DetailTemplate %>" />
