<%@ Page Language="C#" MasterPageFile="~/netin/layout.master" AutoEventWireup="false" CodeFile="friendlink_edit.aspx.cs" Inherits="netin_common_friendlink_edit" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="body">
    <form action="friendlink_edit.aspx" method="post" id="editForm">
