<%@ Page Language="C#" MasterPageFile="~/netin/layout.master" AutoEventWireup="false" CodeFile="banner_edit.aspx.cs" Inherits="netin_common_banner_edit" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="body">
    <form action="banner_edit.aspx" method="post" id="editForm">
        <table class="adminContent">
            ...
            <tr>
                <td class="adminTitle">文本:</td>
                <td class="adminData">
                    <textarea cols="2" rows="3" name="Text" class="textarea-normal"><%=Model.Text %></textarea>
                </td>
            </tr>
